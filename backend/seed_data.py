...
async def seed_database():
    ...
    default_seo_settings = [
        {
            ...
            "json_ld": {
                ...
                "url": "https://fast-load-sync.preview.emergentagent.com",
                "logo": "https://fast-load-sync.preview.emergentagent.com/logo.png",
    ...
    default_robots = {
        "id": "robots-001",
        "content": "User-agent: *\\nAllow: /\\nDisallow: /admin\\n\\nSitemap: https://fast-load-sync.preview.emergentagent.com/sitemap.xml",
        "updated_at": datetime.now(timezone.utc).isoformat()
    }

...
async def seed_database():
    ...
    default_seo_settings = [
        {
            ...
            "json_ld": {
                ...
                "url": "https://sitesync-repair.preview.emergentagent.com",
                "logo": "https://sitesync-repair.preview.emergentagent.com/logo.png",
    ...
    default_robots = {
        "id": "robots-001",
        "content": "User-agent: *\\nAllow: /\\nDisallow: /admin\\n\\nSitemap: https://sitesync-repair.preview.emergentagent.com/sitemap.xml",
        "updated_at": datetime.now(timezone.utc).isoformat()
    }

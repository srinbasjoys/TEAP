...
async def seed_database():
    ...
    default_seo_settings = [
        {
            ...
            "json_ld": {
                ...
                "url": "https://seo-fix-project-2.preview.emergentagent.com",
                "logo": "https://seo-fix-project-2.preview.emergentagent.com/logo.png",
    ...
    default_robots = {
        "id": "robots-001",
        "content": "User-agent: *\\nAllow: /\\nDisallow: /admin\\n\\nSitemap: https://seo-fix-project-2.preview.emergentagent.com/sitemap.xml",
        "updated_at": datetime.now(timezone.utc).isoformat()
    }

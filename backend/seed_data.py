...
async def seed_database():
    ...
    default_seo_settings = [
        {
            ...
            "json_ld": {
                ...
                "url": "https://perfoptimize-1.preview.emergentagent.com",
                "logo": "https://perfoptimize-1.preview.emergentagent.com/logo.png",
    ...
    default_robots = {
        "id": "robots-001",
        "content": "User-agent: *\\nAllow: /\\nDisallow: /admin\\n\\nSitemap: https://perfoptimize-1.preview.emergentagent.com/sitemap.xml",
        "updated_at": datetime.now(timezone.utc).isoformat()
    }
